...
<div class="navbar">
    ...
    <li  class="active"><a href="Active_presiding.php"><font color="white">Active Presiding</font></a></li>
...
<?php $voter_query=mysql_query("select  * from presiding where status='active'");
