...
<div class="navbar">
	...
	<a class="btn btn-danger" id="logout" href="logout.php"><i class="icon-off"></i>&nbsp;Logout</a>
	...
	<div id="element" class="hero-body">
	  <div class="thumbnail_gallery">
			  ...
			  <h2>Mission</h2>
			  <p>Seeks to develop in excellence
