...
<div class="navbar">
    ...
    <li  class="active"><a href="presiding.php"><font color="white">All</font></a></li>
    <li  class=""><a href="Active_presiding.php"><font color="white">presiding officer</font></a></li>
    <li  class=""><a href="new_presiding.php"><font color="white"><i class="icon-plus icon-large"></i>Add Presiding Officer</font></a></li>
...
<?php $voter_query=mysql_query("select  * from presiding");
		while($voter_rows=mysql_fetch_array($voter_query))
			{ $id=$voter_rows['VoterID'];
		?>

<tr class="del<?php echo $id ?>">
	<td><?php echo $voter_rows['PayrollNo']; ?></td>
	...
	<a class="btn btn-Success" href="edit_presiding.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
...
jQuery(".pc_time").val(pc_time);
	...
	$('.btn-danger1').click( function() {
		...
		if(confirm("Are you sure you want to delete this Presiding Officer?")){
			
		
			$.ajax({
			type: "POST",
			url: "delete_presiding.php",
