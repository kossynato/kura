...
<div class="navbar">
	...
	<ul class="nav nav-pills">
	  ...
	  <li><a  href="History.php"><i class="icon-table icon-large"></i>Presiding Officer</a>  
    ...
    <li><a href="C_governor.php"><font color="white">SPIRITUAL AFFAIRS</font></a></li>
    <li  class="active"><a href="C_vice-governor.php"><font color="white">SPORTS</font></a></li>
    <li><a href="C_1st_year.php"><font color="white">SOCIAL AFFAIRS</font></a></li>
    <li><a href="C_2nd_year.php"><font color="white">CATHERING</font></a></li>
    <li><a href="C_3rd_year.php"><font color="white">HOSTEL AND CAMPUS SECURITY</font></a></li>
    S
	...
	<?php
	$query=mysql_query("select  * from candidate where Position='Governor'");
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='Vice-Governor'");
