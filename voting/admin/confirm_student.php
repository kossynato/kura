...
<td>
	<?php
		...
		{
		?>
		<a href="confirm_action.php?session=<?php echo $row['VoterID'];?>" 
		 class="btn btn-info" onclick="return confirm('Decline <?php echo $data?> <?php echo $dataa?>');"> Decline </a>
		<?php
		}
		if(($session)=='1')
		{
		?>
		<a href="confirm_action.php?session=<?php echo $row['VoterID'];?>" 
		 class="btn btn-primary" onclick="return confirm('Incline <?php echo $data?> <?php echo $dataa?>');"> Incline</a>
