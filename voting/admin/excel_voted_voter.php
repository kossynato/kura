...
$worksheet1->freeze_panes(1, 0);
  ...
  $worksheet1->set_column(1, 6, 20);
   ...
   $worksheet1->write_string(5,0,"Voted Voter List");
   ...
   $worksheet1->write_string(7,5,"Year");
...
/////////////////
	...
	$qryreport = mysql_query("SELECT * FROM voters where Status='Voted'") or die(mysql_error());
	...
	$j=$j+1;
			...
			$Status = $reportdisp['Status'];
			 ...
			 $worksheet1->write_string($j,5,"$Year");
