...
<?php
$result=mysql_query("select * from candidate where CandidateID='$id_get'");
$candidate_row=mysql_fetch_array($result);
...
<?php
	...
	$image_size= getimagesize($_FILES['image']['tmp_name']);
		...
		if ($error > 0){
			...
			mysql_query("update candidate set Photo='$location' where CandidateID='$id_get'");
