...
<div class="navbar">
    ...
    <li><a href="4th_year.php"><font color="white">ACADEMICS AND RESEARCH</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='Academics and Research' AND status=1");
