...
<li><a  href="History.php"><i class="icon-table icon-large"></i>Presiding Officer</a>	
    ...
    <li class="active"><a href="candidate_for_vice-governor.php"><font color="white">SPORTS AND ASSOCIATION</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='Sports and Asociation' AND status=1");
