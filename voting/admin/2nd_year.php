...
<div class="navbar">
    ...
    <li  class="active"><a href="2nd_year.php"><font color="white">CATHERING</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate where Position='Cathering' AND status=1");
