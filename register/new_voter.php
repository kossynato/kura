...
<br>
    ...
    <div class="controls">
    <input type="text" name="regno" class="regno" placeholder="Enter Registration Number...">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="FirstName" class="FirstName" placeholder="Enter First Name...">
    </div>
    </div>
    ...
    <div class="controls">
    <input type="text" name="LastName" class="LastName" placeholder="Enter Last Name..." >
    </div>
    </div>
    ...
    <div class="controls">
   <input type="text" name="Section" class="Section" placeholder="Enter Middle Name...">
    </div>
    </div>
    ...
    <div class="controls">
   <select name="Year" class="Year" id="span2" placeholder="Enter year f study..." >
   <option></option>
