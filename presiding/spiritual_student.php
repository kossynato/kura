...
<div class="navbar">
    ...
    <li><a href="spiritual_student.php"><font color="white">SPIRITUAL AFFAIRS</font></a></li>
    <li><a href="sport_student.php"><font color="white">SPORTS AND ASSOCIATION</font></a></li>
    <li><a  href="social_student.php"><font color="white">SOCIAL AFFAIRS</font></a></li>
    <li><a  href="cathering _student.php"><font color="white">CATHERING</font></a></li>
    <li><a  href="hostel_student.php"><font color="white">HOSTEL AND CAMPUS SECURITY</font></a></li>
...
<?php $candidate_query=mysql_query("select  * from candidate  WHERE Position='Spiritual Affairs'  AND status=1");
