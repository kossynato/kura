...
<div class="navbar">
    ...
    <a class="btn btn-primary" id="home"   href="../kura/index.php"><i class="icon-off"></i>&nbsp;Home</a>
 ...
 <li><a href="index.php"><font color="white">All</font></a></li>
    ...
    <li><a  href="hostel.php"><font color="white">HOSTEL AND CAMPUS SECURITY</font></a></li>
	</div>
	<br>
	<br>
